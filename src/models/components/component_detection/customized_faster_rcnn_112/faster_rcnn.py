...
from src.models.components.component_detection.customized_faster_rcnn_112.rpn import RPNHead, RegionProposalNetwork
...
class FasterRCNN(GeneralizedRCNN):
    ...
    def __init__(
        ...
        if use_object_relation_modules:
            ...
            if not isinstance(box_head, FastRCNNConvFCHead):
        ...
        super().__init__(backbone, rpn, roi_heads, transform, relation_network,
