...
from src.models.components.component_detection.customized_faster_rcnn_112.faster_rcnn import FasterRCNN, \
    FastRCNNConvFCHead, RPNHead, _default_anchorgen
...
class MaskRCNN(FasterRCNN):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            relation_network_first_layer_type,
            ...
            relation_network_feat_embedding_type,
            relation_network_encapsulation_box_masks_strategy,
            use_object_relation_modules,
            box_head_output_strategy,
            ...
            relation_network_representation_size,
            use_edge_maps,
...
def maskrcnn_resnet50_fpn_v2(
    ...
    if weights is not None:
        ...
        try:
            ...
            print("exception in _overwrite_value_param", e)
            num_classes = _ovewrite_value_param("", num_classes, len(weights.meta["categories"]))
    elif num_classes is None:
        num_classes = 91
